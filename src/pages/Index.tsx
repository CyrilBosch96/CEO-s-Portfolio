    ...
    <>
      ...
      <div className="min-h-screen" style={{
        ...
        <main className="pt-16 sm:pt-20 min-h-screen flex flex-col relative overflow-hidden">
          ...
          {/* Right Side Text */}
          <div className="absolute top-1/2 right-2 sm:right-4 md:right-8 transform -translate-y-1/2 text-right z-10">
            <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-light text-white leading-relaxed drop-shadow-lg">
              <div>Innovator</div>
              <div>Investor</div>
              <div>Leader</div>
            </div>
          ...
          <div className="absolute bottom-4 sm:bottom-8 left-0 right-0 z-10">
            <div className="overflow-hidden whitespace-nowrap">
              <div className="animate-marquee inline-block text-4xl sm:text-6xl md:text-8xl lg:text-9xl xl:text-[12rem] font-bold text-white tracking-tight drop-shadow-lg">
